...
fit_d <- nlsLM(cell_density ~ 800 * (1+(a*exp(b*temp)*(1-((temp-z)/(w/2))^2)))^(days),
               data= cells_days,  start=list(z=14.19,w=36,a=0.2,b=0.1),
               lower = c(15, 10, -0.2, -0.2),
               upper = c(30, 70, 1.2, 0.3),
               control = nls.control(maxiter=1000, minFactor=1/204800000))
...
cells_days %>% 
  ggplot(aes(x = days, y = cell_density, color = factor(temp))) + geom_point() +
  stat_function(fun = growth_fun_27, color = "black") +ylim(0, 30000) +
  stat_function(fun = growth_fun_5, color = "black") +
  stat_function(fun = growth_fun_10, color = "black") +
  stat_function(fun = growth_fun_24, color = "black") +
  stat_function(fun = growth_fun_16, color = "black") +
  stat_function(fun = growth_fun_29, color = "black") +
  theme_bw() 
...
p + stat_function(fun = tpc1, color = "black", size = 1) +xlim(-2, 33) + 
  ylim(-2, 5)
